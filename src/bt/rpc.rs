...
use super::super::proto::{KQueryArg};
use super::super::proto::serde::{serde_socket_addr, serde_option_bool};

use super::super::id::Sha1Id;
...
mod serde_nodes_info {
    use super::{BtDhtId, BtDhtNodeInfo};
    use super::super::super::proto::serde::socket_addr;
    use serde_bytes;
    use serde::ser::Serializer;
    use serde::de::{Deserializer, Error};
    use super::super::super::id::sha1::serde_hash;
...
mod tests {
    ...
    use hexdump::hexdump;
    use super::super::super::proto::krpc::{KAddress, KMessage, KError, KErrorKind};
